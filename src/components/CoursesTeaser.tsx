...
export default function CoursesTeaser() {
  ...
  return (
    <section id="courses" className="py-20 bg-red-50/40 border-t border-red-200/80 relative">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-14">
          <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-red-100 text-red-950 border border-red-200">
            <GraduationCap className="w-3.5 h-3.5 text-red-800" />
          ...
          {[
            {
              ...
              badgeColor: "bg-red-100 text-red-950 border-red-200",
              href: "/courses/ess",
              count: essCount,
            ...
            <Link key={card.label} href={card.href} className="group block" style={{ textDecoration: "none" }}>
              <div className="rounded-3xl border border-red-200 bg-white p-7 hover:border-red-400 hover:-translate-y-1 hover:shadow-xl hover:shadow-red-950/5 transition-all duration-300 cursor-pointer h-full flex flex-col justify-between space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-xl text-zinc-900 group-hover:text-red-800 transition-colors">
                      {card.full}
                    </h3>
                ...
                <div className="pt-4 border-t border-red-100 flex items-center justify-between">
                  ...
                  <div className="inline-flex items-center gap-2 text-xs font-extrabold text-red-800 group-hover:translate-x-1 transition-transform">
