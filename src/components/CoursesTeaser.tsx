...
export default function CoursesTeaser() {
  ...
  return (
    <section id="courses" className="py-20 bg-[#fffdf0] border-t border-amber-200/80 relative">
          ...
          {[
            {
              ...
              badgeColor: "bg-[#ffe588] text-amber-950 border-amber-300",
              href: "/courses/ess",
              count: essCount,
            ...
            <Link key={card.label} href={card.href} className="group block" style={{ textDecoration: "none" }}>
              <div className="rounded-3xl border border-amber-200 bg-white p-7 hover:border-amber-400 hover:-translate-y-1 hover:shadow-xl hover:shadow-stone-900/5 transition-all duration-300 cursor-pointer h-full flex flex-col justify-between space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-xl text-stone-900 group-hover:text-amber-700 transition-colors">
                      {card.full}
                    </h3>
                ...
                <div className="pt-4 border-t border-amber-100 flex items-center justify-between">
                  ...
                  <div className="inline-flex items-center gap-2 text-xs font-black text-amber-800 group-hover:translate-x-1 transition-transform">
