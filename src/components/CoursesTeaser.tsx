        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-4xl mx-auto">
          {[
            ...
            <Link key={card.label} href={card.href} className="group block" style={{ textDecoration: "none" }}>
              <div className="rounded-3xl border border-slate-200 bg-white p-7 hover:border-slate-400 hover:-translate-y-1 hover:shadow-xl hover:shadow-slate-200/50 transition-all duration-300 cursor-pointer h-full flex flex-col justify-between space-y-6">
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    <h3 className="font-extrabold text-xl text-slate-900 group-hover:text-slate-700 transition-colors">
                      {card.full}
                    </h3>
                ...
                <div className="pt-4 border-t border-slate-100 flex items-center justify-between">
                  ...
                  <div className="inline-flex items-center gap-2 text-xs font-extrabold text-slate-900 group-hover:translate-x-1 transition-transform">
