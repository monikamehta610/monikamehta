...
export default function Hero() {
  return (
    <section
      id="home"
      className="relative min-h-[92vh] flex flex-col justify-between pt-24 pb-12 overflow-hidden bg-gradient-to-b from-teal-50/60 via-white to-sky-50/40"
    >
      {/* Soft background glows */}
      <div className="absolute inset-0 z-0 overflow-hidden pointer-events-none">
        <div className="absolute top-[10%] left-[10%] w-[400px] h-[400px] rounded-full bg-teal-400/10 blur-[130px] animate-pulse-slow" />
        <div className="absolute bottom-[10%] right-[10%] w-[450px] h-[450px] rounded-full bg-sky-400/10 blur-[140px] animate-pulse-slow [animation-delay:2s]" />
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 w-full flex-1 flex flex-col justify-center">
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-8 items-center py-8 lg:py-12">
          ...
          <div className="lg:col-span-7 flex flex-col items-center lg:items-start text-center lg:text-left space-y-6 animate-fade-in-up">
            ...
            {/* Top pill badge */}
            <div className="inline-flex items-center gap-2 px-3.5 py-1.5 rounded-full text-xs font-bold bg-teal-100/80 text-teal-950 border border-teal-200 shadow-xs">
            ...
            <div className="flex flex-col sm:flex-row items-center gap-3.5 w-full sm:w-auto pt-2">
              <a
                href="#contact"
                className="group inline-flex items-center justify-center gap-2.5 px-6 py-3.5 rounded-2xl bg-teal-600 text-white font-extrabold text-sm shadow-lg shadow-teal-600/20 hover:bg-teal-700 hover:scale-[1.02] transition-all duration-300 w-full sm:w-auto cursor-pointer"
              >
              ...
              <Link
                href="/courses/ess"
                className="inline-flex items-center justify-center gap-2 px-6 py-3.5 rounded-2xl bg-white border border-teal-200 text-slate-800 font-bold text-sm hover:bg-teal-50 hover:text-teal-950 shadow-xs transition-all duration-300 w-full sm:w-auto cursor-pointer"
              >
            ...
            {/* Key Stats Bar */}
            <div className="grid grid-cols-3 gap-4 pt-6 border-t border-teal-200/80 w-full max-w-lg">
              <div>
              ...
              <div>
                <div className="text-2xl sm:text-3xl font-black text-teal-600">100s</div>
                <div className="text-xs text-slate-600 font-semibold mt-0.5">Students Taught</div>
              </div>
              <div>
                <div className="text-2xl sm:text-3xl font-black text-sky-600">Level 7</div>
          ...
          <div className="lg:col-span-5 flex justify-center items-center animate-fade-in-up [animation-delay:0.2s]">
            <div className="relative group w-full max-w-md">
              ...
              <div className="relative rounded-3xl border border-teal-200/90 bg-white/95 backdrop-blur-xl p-6 shadow-2xl shadow-slate-900/5 space-y-5">
                <div className="flex items-center justify-between border-b border-teal-100 pb-4">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-10 rounded-xl bg-teal-50 border border-teal-200 flex items-center justify-center text-teal-600 font-black text-lg">
                      🎓
                    </div>
                    <div>
                  ...
                  <span className="text-[10px] font-extrabold uppercase tracking-wider text-teal-950 bg-teal-100 px-2.5 py-1 rounded-full border border-teal-200">
                    Accepting Students
                  </span>
                </div>
                ...
                <div className="space-y-3">
                  {[
                    { icon: CheckCircle2, color: "text-teal-600", title: "IBDP Biology & ESS Tutoring", desc: "One-on-one personalized coaching targeting Level 7 scores" },
                    { icon: Award, color: "text-sky-600", title: "Internal Assessment (IA) Mentorship", desc: "Expert guidance from topic selection to data analysis" },
                    { icon: FileText, color: "text-teal-700", title: "University Science Lecturing", desc: "Microbiology, Genetics, and General Biology instruction" },
                    ...
                    <div key={i} className="flex items-start gap-3 p-2.5 rounded-xl bg-teal-50/50 border border-teal-100">
                ...
                <a
                  href="#contact"
                  className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs shadow-md transition-colors"
                >
        ...
        <div className="mt-10 pt-8 border-t border-teal-200/80">
          ...
          <div className="flex items-center justify-center gap-6 sm:gap-12 flex-wrap">
            {[
              ...
              <div
                key={i}
                className="flex items-center gap-3 px-4 py-2.5 rounded-2xl bg-white border border-teal-200/90 shadow-xs hover:shadow-md hover:border-teal-300 transition-all duration-200 grayscale hover:grayscale-0"
              >
