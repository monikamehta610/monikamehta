...
export default function CourseClientPortal({ course }: { course: Course }) {
  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "2.5rem 1.5rem 5rem" }}>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: "0.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", fontSize: "0.75rem", fontWeight: 600 }}>
              <span style={{ background: "#f1f5f9", color: "#475569", padding: "3px 10px", borderRadius: 9999 }}>
          ...
          <div style={{ height: 6, background: "#f1f5f9", borderRadius: 9999, overflow: "hidden" }}>
            <div
              style={{
                ...
                height: "100%",
                background: `linear-gradient(90deg, ${course.accentColor}, #10b981)`,
                borderRadius: 9999,
      ...
      <div style={{ display: "flex", gap: "0.5rem", borderBottom: "1px solid #e2e8f0", marginBottom: "2rem", paddingBottom: "0.25rem" }}>
        {[
            ...
            <div style={{ display: "flex", gap: "0.5rem", overflowX: "auto", paddingBottom: "0.25rem", scrollbarWidth: "none" }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  whiteSpace: "nowrap",
                  border: selectedUnit === "all" ? `1.5px solid ${course.accentColor}` : "1px solid #e2e8f0",
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      whiteSpace: "nowrap",
                      border: isSelected ? `1.5px solid ${course.accentColor}` : "1px solid #e2e8f0",
                    ...
                    {slides.map((slide) => {
                      ...
                      const cardInner = (
                        <div
                          style={{
                            background: "#ffffff",
                            border: isComingSoon ? "1px dashed #e2e8f0" : "1px solid #e2e8f0",
                            borderRadius: 14,
                          ...
                          className={!isComingSoon ? "hover:border-blue-500/40 hover:shadow-md hover:-translate-y-0.5" : ""}
                        >
      ...
      {activeTab === "questions" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 16, padding: "1.5rem", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
                ...
                >
                  ...
                  {isExpanded && (
                    <div style={{ padding: "1.5rem", borderTop: "1px solid #e2e8f0", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                      {/* Tips */}
                      <div>
                        <h4 style={{ fontSize: "0.8125rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.05em", color: "#10b981", marginBottom: "0.5rem" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                        {set.questions.map((qItem, qIdx) => (
                          <div key={qIdx} style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 12, padding: "1rem 1.25rem" }}>
                            <div style={{ fontWeight: 700, color: "#0f172a", fontSize: "0.9rem", marginBottom: "0.5rem" }}>
                              Q{qIdx + 1}: {qItem.q}
                            </div>
                            <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 8, padding: "0.75rem 1rem", fontSize: "0.8125rem", color: "#475569", lineHeight: 1.65, whiteSpace: "pre-line" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(420px, 1fr))", gap: "1rem" }}>
              {IA_CRITERIA.map((crit, idx) => (
                <div key={idx} style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 14, padding: "1.25rem", boxShadow: "0 1px 4px rgba(0,0,0,0.02)" }}>
                  <h4 style={{ fontSize: "0.95rem", fontWeight: 800, color: course.accentColor, margin: "0 0 0.25rem 0" }}>
                    {crit.title}
                  </h4>
                  <p style={{ fontSize: "0.8125rem", color: "#334155", fontWeight: 600, margin: "0 0 0.75rem 0" }}>
                    Focus: {crit.focus}
                  </p>
          ...
          <div style={{ background: "#ffffff", border: "1px solid #e2e8f0", borderRadius: 16, padding: "1.5rem", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
              {SAMPLE_IA_TOPICS.map((topic, tIdx) => (
                <div key={tIdx} style={{ background: "#f8fafc", border: "1px solid #e2e8f0", borderRadius: 10, padding: "0.75rem 1rem", fontSize: "0.85rem", color: "#334155", display: "flex", alignItems: "center", gap: "0.75rem" }}>
