  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "2.5rem 1.5rem 5rem" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "#475569", fontSize: "0.95rem", lineHeight: 1.6, maxWidth: 680 }}>
          {course.description}
        </p>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: "0.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", fontSize: "0.75rem", fontWeight: 600 }}>
              <span style={{ background: "#f5f5f4", color: "#475569", padding: "3px 10px", borderRadius: 9999 }}>
          ...
          return (
            <button
              ...
              style={{
                ...
                color: isActive ? course.accentColor : "#64748b",
                ...
                {(["all", "SL", "HL"] as const).map((lvl) => (
                  <button
                    ...
                    style={{
                      ...
                      color: selectedLevel === lvl ? course.accentColor : "#64748b",
            ...
            <div style={{ display: "flex", gap: "0.5rem", overflowX: "auto", paddingBottom: "0.25rem", scrollbarWidth: "none" }}>
              <button
                ...
                style={{
                  ...
                  color: selectedUnit === "all" ? course.accentColor : "#64748b",
                  cursor: "pointer",
                  transition: "all 0.15s ease",
                }}
              >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      color: isSelected ? course.accentColor : "#64748b",
                      cursor: "pointer",
                      transition: "all 0.15s ease",
                    }}
                  >
                    ...
                    {slides.map((slide) => {
                      ...
                      const cardInner = (
                        <div
                          ...
                          className={!isComingSoon ? "hover:border-slate-400 hover:shadow-md hover:-translate-y-0.5" : ""}
                        >
                          <div style={{ minWidth: 0, flex: 1 }}>
                            ...
                            <p style={{ fontSize: "0.8125rem", color: "#64748b", margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              {slide.subtitle}
                            </p>
                          </div>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <p style={{ fontSize: "0.8125rem", color: "#64748b", margin: 0 }}>{set.description}</p>
                    </div>
                    ...
                    <div style={{ padding: "1.5rem", borderTop: "1px solid #e7e5e4", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                        {set.questions.map((qItem, qIdx) => (
                          <div key={qIdx} style={{ background: "#fafaf9", border: "1px solid #e7e5e4", borderRadius: 12, padding: "1rem 1.25rem" }}>
                            <div style={{ fontWeight: 700, color: "#0f172a", fontSize: "0.9rem", marginBottom: "0.5rem" }}>
                              Q{qIdx + 1}: {qItem.q}
                            </div>
                            <div style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 8, padding: "0.75rem 1rem", fontSize: "0.8125rem", color: "#475569", lineHeight: 1.65, whiteSpace: "pre-line" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(420px, 1fr))", gap: "1rem" }}>
              {IA_CRITERIA.map((crit, idx) => (
                <div key={idx} style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 14, padding: "1.25rem", boxShadow: "0 1px 4px rgba(0,0,0,0.02)" }}>
                  ...
                  <ul style={{ margin: 0, paddingLeft: "1.2rem", color: "#64748b", fontSize: "0.8rem", lineHeight: 1.6 }}>
          ...
          <div style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 16, padding: "1.5rem", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
            <h3 style={{ fontSize: "1.1rem", fontWeight: 800, color: "#0f172a", margin: "0 0 1rem 0", display: "flex", alignItems: "center", gap: "0.5rem" }}>
              <Lightbulb size={18} style={{ color: "#334155" }} />
              High-Scoring Sample ESS IA Research Questions
            </h3>
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
              {SAMPLE_IA_TOPICS.map((topic, tIdx) => (
                <div key={tIdx} style={{ background: "#fafaf9", border: "1px solid #e7e5e4", borderRadius: 10, padding: "0.75rem 1rem", fontSize: "0.85rem", color: "#0f172a", display: "flex", alignItems: "center", gap: "0.75rem" }}>
