  ...
  return (
    <div style={{ maxWidth: 960, margin: "0 auto", padding: "2.5rem 1.5rem 5rem" }}>
      ...
      <div style={{ marginBottom: "2rem" }}>
        ...
        <p style={{ color: "#44403c", fontSize: "0.95rem", lineHeight: 1.6, maxWidth: 680 }}>
          {course.description}
        </p>
        ...
        >
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem", marginBottom: "0.75rem" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem", fontSize: "0.75rem", fontWeight: 600 }}>
              <span style={{ background: "#f5f5f4", color: "#44403c", padding: "3px 10px", borderRadius: 9999 }}>
          ...
          <div style={{ height: 6, background: "#f5f5f4", borderRadius: 9999, overflow: "hidden" }}>
            <div
              style={{
                ...
                height: "100%",
                background: `linear-gradient(90deg, ${course.accentColor}, #059669)`,
                borderRadius: 9999,
      ...
      <div style={{ display: "flex", gap: "0.5rem", borderBottom: "1px solid #e7e5e4", marginBottom: "2rem", paddingBottom: "0.25rem" }}>
        {[
          ...
          return (
            <button
              ...
              style={{
                ...
                border: "none",
                cursor: "pointer",
                background: isActive ? course.accentColor + "12" : "transparent",
                color: isActive ? course.accentColor : "#78716c",
        ...
        <div>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1rem", marginBottom: "2rem" }}>
            ...
            <div style={{ display: "flex", gap: "0.75rem", flexWrap: "wrap", alignItems: "center" }}>
              ...
              {/* Level Filter Toggle */}
              <div style={{ display: "flex", background: "#f5f5f4", padding: 3, borderRadius: 12, border: "1px solid #e7e5e4" }}>
                {(["all", "SL", "HL"] as const).map((lvl) => (
                  <button
                    ...
                    style={{
                      ...
                      color: selectedLevel === lvl ? course.accentColor : "#78716c",
            ...
            <div style={{ display: "flex", gap: "0.5rem", overflowX: "auto", paddingBottom: "0.25rem", scrollbarWidth: "none" }}>
              <button
                ...
                style={{
                  ...
                  fontWeight: 600,
                  whiteSpace: "nowrap",
                  border: selectedUnit === "all" ? `1.5px solid ${course.accentColor}` : "1px solid #e7e5e4",
                  background: selectedUnit === "all" ? course.accentColor + "14" : "#ffffff",
                  color: selectedUnit === "all" ? course.accentColor : "#78716c",
                  cursor: "pointer",
                  transition: "all 0.15s ease",
                }}
              >
                ...
                return (
                  <button
                    ...
                    style={{
                      ...
                      fontWeight: 600,
                      whiteSpace: "nowrap",
                      border: isSelected ? `1.5px solid ${course.accentColor}` : "1px solid #e7e5e4",
                      background: isSelected ? course.accentColor + "14" : "#ffffff",
                      color: isSelected ? course.accentColor : "#78716c",
                      cursor: "pointer",
                      transition: "all 0.15s ease",
                    }}
                  >
                    ...
                    {slides.map((slide) => {
                      ...
                      const cardInner = (
                        <div
                          style={{
                            background: "#ffffff",
                            border: isComingSoon ? "1px dashed #e7e5e4" : "1px solid #e7e5e4",
                            borderRadius: 14,
                          ...
                          className={!isComingSoon ? "hover:border-orange-500/40 hover:shadow-md hover:-translate-y-0.5" : ""}
                        >
                          <div style={{ minWidth: 0, flex: 1 }}>
                            ...
                            <p style={{ fontSize: "0.8125rem", color: "#78716c", margin: 0, overflow: "hidden", textOverflow: "ellipsis", whiteSpace: "nowrap" }}>
                              {slide.subtitle}
                            </p>
                          </div>
      ...
      {activeTab === "questions" && (
        <div style={{ display: "flex", flexDirection: "column", gap: "2rem" }}>
          <div style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 16, padding: "1.5rem", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
            ...
            <p style={{ color: "#44403c", fontSize: "0.875rem", lineHeight: 1.6, margin: 0 }}>
                ...
                >
                  ...
                  >
                    <div>
                      ...
                      <p style={{ fontSize: "0.8125rem", color: "#78716c", margin: 0 }}>{set.description}</p>
                    </div>
                  ...
                  {isExpanded && (
                    <div style={{ padding: "1.5rem", borderTop: "1px solid #e7e5e4", display: "flex", flexDirection: "column", gap: "1.5rem" }}>
                      {/* Tips */}
                      <div>
                        <h4 style={{ fontSize: "0.8125rem", fontWeight: 800, textTransform: "uppercase", letterSpacing: "0.05em", color: "#059669", marginBottom: "0.5rem" }}>
                          💡 Pro Strategy Checkpoints:
                        </h4>
                        <ul style={{ margin: 0, paddingLeft: "1.25rem", color: "#292524", fontSize: "0.85rem", lineHeight: 1.6 }}>
                          {set.tips.map((t, idx) => (
                      ...
                      <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
                        {set.questions.map((qItem, qIdx) => (
                          <div key={qIdx} style={{ background: "#fdfbf7", border: "1px solid #e7e5e4", borderRadius: 12, padding: "1rem 1.25rem" }}>
                            <div style={{ fontWeight: 700, color: "#1c1917", fontSize: "0.9rem", marginBottom: "0.5rem" }}>
                              Q{qIdx + 1}: {qItem.q}
                            </div>
                            <div style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 8, padding: "0.75rem 1rem", fontSize: "0.8125rem", color: "#44403c", lineHeight: 1.65, whiteSpace: "pre-line" }}>
          ...
          <div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fill, minmax(420px, 1fr))", gap: "1rem" }}>
              {IA_CRITERIA.map((crit, idx) => (
                <div key={idx} style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 14, padding: "1.25rem", boxShadow: "0 1px 4px rgba(0,0,0,0.02)" }}>
                  <h4 style={{ fontSize: "0.95rem", fontWeight: 800, color: course.accentColor, margin: "0 0 0.25rem 0" }}>
                    {crit.title}
                  </h4>
                  <p style={{ fontSize: "0.8125rem", color: "#292524", fontWeight: 600, margin: "0 0 0.75rem 0" }}>
                    Focus: {crit.focus}
                  </p>
                  <ul style={{ margin: 0, paddingLeft: "1.2rem", color: "#78716c", fontSize: "0.8rem", lineHeight: 1.6 }}>
          ...
          <div style={{ background: "#ffffff", border: "1px solid #e7e5e4", borderRadius: 16, padding: "1.5rem", boxShadow: "0 2px 8px rgba(0,0,0,0.03)" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "0.625rem" }}>
              {SAMPLE_IA_TOPICS.map((topic, tIdx) => (
                <div key={tIdx} style={{ background: "#fdfbf7", border: "1px solid #e7e5e4", borderRadius: 10, padding: "0.75rem 1rem", fontSize: "0.85rem", color: "#292524", display: "flex", alignItems: "center", gap: "0.75rem" }}>
