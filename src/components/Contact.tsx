...
export default function Contact() {
  ...
  return (
    <section id="contact" className="py-20 bg-white border-t border-teal-200/80 relative">
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-14">
          ...
          <div className="pt-2">
            <a
              href="#contact-form"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-extrabold text-sm shadow-md shadow-teal-600/10 hover:scale-[1.02] transition-all"
            >
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-8 items-stretch" id="contact-form">
          ...
          <div className="md:col-span-5 flex flex-col justify-between p-8 rounded-3xl border border-teal-200 bg-teal-50/40 space-y-8 shadow-xs">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                <span className="p-3 rounded-xl bg-white border border-teal-200 text-teal-600 shadow-xs">
                ...
                <div>
                  ...
                  {showEmail ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-800 hover:text-teal-600 bg-white border border-teal-200 px-2.5 py-1 rounded-lg transition-colors cursor-pointer mt-0.5"
                    >
              ...
              {/* Protected Phone */}
              <div className="flex items-center gap-3">
                <span className="p-3 rounded-xl bg-white border border-teal-200 text-sky-600 shadow-xs">
                ...
                <div>
                  ...
                  {showPhone ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-800 hover:text-sky-600 bg-white border border-teal-200 px-2.5 py-1 rounded-lg transition-colors cursor-pointer mt-0.5"
                    >
            ...
            <div className="flex items-center gap-2 text-xs text-slate-500 pt-4 border-t border-teal-200">
          ...
          <div className="md:col-span-7 p-8 rounded-3xl border border-teal-200 bg-white shadow-md">
            {status === "success" ? (
              <div className="flex flex-col items-center justify-center text-center py-12 space-y-4 h-full">
                <div className="p-3 rounded-full bg-teal-100 text-teal-950 border border-teal-200">
                ...
                <button
                  ...
                  className="px-6 py-2.5 rounded-xl bg-teal-100 hover:bg-teal-200 text-teal-950 font-bold text-xs transition-colors cursor-pointer"
                >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-teal-200 bg-teal-50/20 text-slate-900 text-sm focus:outline-none focus:border-teal-600 transition-colors"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 px-6 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-extrabold text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
