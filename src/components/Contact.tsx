      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-14">
          ...
          <div className="pt-2">
            <a
              href="#contact-form"
              className="inline-flex items-center gap-2 px-6 py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-sm shadow-md shadow-slate-900/10 hover:scale-[1.02] transition-all"
            >
          ...
          <div className="md:col-span-5 flex flex-col justify-between p-8 rounded-3xl border border-slate-200 bg-slate-50/70 space-y-8 shadow-xs">
            ...
            <div className="space-y-6">
              ...
              <div className="flex items-center gap-3">
                <span className="p-3 rounded-xl bg-white border border-slate-200 text-slate-700 shadow-xs">
                ...
                <div>
                  ...
                  {showEmail ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-700 hover:text-slate-900 bg-white border border-slate-200 px-2.5 py-1 rounded-lg transition-colors cursor-pointer mt-0.5"
                    >
              ...
              {/* Protected Phone */}
              <div className="flex items-center gap-3">
                <span className="p-3 rounded-xl bg-white border border-slate-200 text-emerald-700 shadow-xs">
                ...
                <div>
                  ...
                  {showPhone ? (
                    ...
                    <button
                      ...
                      className="inline-flex items-center gap-1.5 text-xs font-bold text-slate-700 hover:text-emerald-700 bg-white border border-slate-200 px-2.5 py-1 rounded-lg transition-colors cursor-pointer mt-0.5"
                    >
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl border border-slate-200 bg-slate-50/50 text-slate-900 text-sm focus:outline-none focus:border-slate-700 transition-colors"
                  />
                </div>
                ...
                <button
                  ...
                  className="w-full py-3 px-6 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-extrabold text-sm shadow-md transition-all flex items-center justify-center gap-2 cursor-pointer"
                >
