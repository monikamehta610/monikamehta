...
export default function IaEeGuide() {
  return (
    <section id="ia-ee" className="py-20 bg-white border-t border-teal-200/80 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-teal-400/5 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-teal-200 bg-teal-50/40 p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-teal-300 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-extrabold uppercase tracking-wider text-teal-950 bg-teal-100 px-3 py-1 rounded-full border border-teal-200">
            ...
            <div className="pt-4 border-t border-teal-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-xs shadow-md shadow-teal-600/10 transition-all"
              >
          ...
          <div className="rounded-3xl border border-teal-200 bg-teal-50/40 p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-teal-300 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-extrabold uppercase tracking-wider text-sky-950 bg-sky-100 px-3 py-1 rounded-full border border-sky-200">
            ...
            <div className="pt-4 border-t border-teal-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-sky-600 hover:bg-sky-700 text-white font-bold text-xs shadow-md shadow-sky-600/10 transition-all"
              >
