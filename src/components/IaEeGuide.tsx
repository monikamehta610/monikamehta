...
export default function IaEeGuide() {
  return (
    <section id="ia-ee" className="py-20 bg-white border-t border-stone-200/80 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-orange-400/5 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-col items-center text-center space-y-4 mb-16">
          ...
          <p className="text-stone-600 max-w-2xl text-center text-sm sm:text-base leading-relaxed">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-stone-200 bg-stone-50/60 p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-orange-300 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-extrabold uppercase tracking-wider text-orange-800 bg-orange-50 px-3 py-1 rounded-full border border-orange-200">
                  25% of Final IB Grade
                </span>
              </div>

              <h3 className="text-2xl font-bold text-stone-900">ESS Internal Assessment (IA)</h3>
              ...
              <div className="space-y-2.5 pt-2">
                <div className="text-xs font-bold text-stone-800 uppercase tracking-wider">Four Assessment Criteria:</div>
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5 text-xs text-stone-600">
                    ...
                    <div>
                      <strong className="text-stone-900">{crit.name}:</strong> {crit.desc}
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="pt-4 border-t border-stone-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-orange-600 hover:bg-orange-700 text-white font-bold text-xs shadow-md shadow-orange-600/20 transition-all"
              >
          ...
          <div className="rounded-3xl border border-stone-200 bg-stone-50/60 p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-amber-300 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-amber-100/80 border border-amber-200 flex items-center justify-center text-amber-600">
              ...
              <h3 className="text-2xl font-bold text-stone-900">ESS Extended Essay (EE)</h3>
              <p className="text-sm text-stone-600 leading-relaxed">
                An independent interdisciplinary research paper integrating environmental science with human societal perspectives.
              </p>

              <div className="space-y-2.5 pt-2">
                <div className="text-xs font-bold text-stone-800 uppercase tracking-wider">Key Success Factors:</div>
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5 text-xs text-stone-600">
                    ...
                    <div>
                      <strong className="text-stone-900">{item.name}:</strong> {item.desc}
                    </div>
                  </div>
                ))}
              </div>
            ...
            <div className="pt-4 border-t border-stone-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-amber-600 hover:bg-amber-700 text-white font-bold text-xs shadow-md shadow-amber-600/20 transition-all"
              >
