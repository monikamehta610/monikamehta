...
export default function IaEeGuide() {
  return (
    <section id="ia-ee" className="py-20 bg-white border-t border-amber-200/80 relative overflow-hidden">
      {/* Background glow */}
      <div
        className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] blur-[160px] rounded-full pointer-events-none"
        style={{ background: "rgba(255, 229, 136, 0.35)" }}
      />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-amber-200 bg-[#fffef0] p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-amber-400 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl border border-amber-300 flex items-center justify-center text-amber-950" style={{ background: "#ffe588" }}>
                  <Target className="w-6 h-6" />
                </div>
                <span className="text-xs font-black uppercase tracking-wider text-amber-950 px-3 py-1 rounded-full border border-amber-300" style={{ background: "#ffe588" }}>
              ...
              <div className="space-y-2.5 pt-2">
                <div className="text-xs font-bold text-stone-900 uppercase tracking-wider">Four Assessment Criteria:</div>
                {[
            ...
            <div className="pt-4 border-t border-amber-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl text-amber-950 font-black text-xs shadow-md transition-all"
          ...
          <div className="rounded-3xl border border-amber-200 bg-[#fffef0] p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-amber-400 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-black uppercase tracking-wider text-amber-950 bg-amber-100 px-3 py-1 rounded-full border border-amber-300">
              ...
              <div className="space-y-2.5 pt-2">
                <div className="text-xs font-bold text-stone-900 uppercase tracking-wider">Key Success Factors:</div>
                {[
            ...
            <div className="pt-4 border-t border-amber-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-amber-700 hover:bg-amber-800 text-white font-bold text-xs shadow-md transition-all"
              >
