...
export default function IaEeGuide() {
  return (
    <section id="ia-ee" className="py-20 bg-white border-t border-slate-200/80 relative overflow-hidden">
      {/* Background glow */}
      <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[500px] bg-slate-400/5 blur-[150px] rounded-full pointer-events-none" />
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-slate-400 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                <span className="text-xs font-extrabold uppercase tracking-wider text-slate-800 bg-slate-100 px-3 py-1 rounded-full border border-slate-200">
            ...
            <div className="pt-4 border-t border-slate-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-slate-900 hover:bg-slate-800 text-white font-bold text-xs shadow-md shadow-slate-900/10 transition-all"
              >
          ...
          <div className="rounded-3xl border border-slate-200 bg-slate-50/60 p-8 space-y-6 flex flex-col justify-between shadow-xs hover:shadow-xl hover:border-slate-400 transition-all">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                <div className="w-12 h-12 rounded-2xl bg-stone-100 border border-stone-200 flex items-center justify-center text-stone-800">
                  <Compass className="w-6 h-6" />
                </div>
                <span className="text-xs font-extrabold uppercase tracking-wider text-stone-800 bg-stone-100 px-3 py-1 rounded-full border border-stone-200">
              ...
              <div className="space-y-2.5 pt-2">
                ...
                {[
                  ...
                  <div key={i} className="flex items-start gap-2.5 text-xs text-slate-600">
                    <Lightbulb className="w-4 h-4 text-slate-700 flex-shrink-0 mt-0.5" />
                    <div>
            ...
            <div className="pt-4 border-t border-slate-200">
              <Link
                ...
                className="inline-flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-slate-800 hover:bg-slate-700 text-white font-bold text-xs shadow-md shadow-slate-800/10 transition-all"
              >
